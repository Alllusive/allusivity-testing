...
public class NetherConduitBlockEntity extends BlockEntity {
    ...
    public static void clientTick(World world, BlockPos pos, BlockState state, net.allusive.allusivity_.block.entity.NetherConduitBlockEntity blockEntity) {
        ++blockEntity.ticks;
    ...
    public static void serverTick(World world, BlockPos pos, BlockState state, net.allusive.allusivity_.block.entity.NetherConduitBlockEntity blockEntity) {
        ++blockEntity.ticks;
        long l = world.getTime();
        List<BlockPos> list = blockEntity.activatingBlocks;
        if (l % 40L == 0L) {
    ...
    private static void openEye(net.allusive.allusivity_.block.entity.NetherConduitBlockEntity blockEntity, List<BlockPos> activatingBlocks) {
    ...
    private static void attackHostileEntity(World world, BlockPos pos, BlockState state, List<BlockPos> activatingBlocks, net.allusive.allusivity_.block.entity.NetherConduitBlockEntity blockEntity) {
    ...
    private static void updateTargetEntity(World world, BlockPos pos, net.allusive.allusivity_.block.entity.NetherConduitBlockEntity blockEntity) {
