package net.allusive.allusivity_.item;

import net.allusive.allusivity_.Allusivity;
import net.allusive.allusivity_.item.custom.*;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registry.ITEM, new Identifier(Allusivity.MOD_ID, name), item);
    }


    public static void registerModItems() {
        Allusivity.LOGGER.info("Registering Mod Items for " + Allusivity.MOD_ID);
    }
}
